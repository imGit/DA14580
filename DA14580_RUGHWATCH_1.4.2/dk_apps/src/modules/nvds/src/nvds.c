...
const struct nvds_data_struct nvds_data_storage __attribute__((section("nvds_data_storage_area"))) =	
{
    ...
    .NVDS_TAG_DEVICE_NAME                   = DGC_DEVICE_NAME,		//Device title
    .NVDS_TAG_BD_ADDRESS                    = {0x88, 0x77, 0x66, 0x55, 0x44, 0x11},//{0x15, 0x77, 0x66, 0x55, 0x23, 0x11},
    .ADV_DATA_TAG_LEN                       = 7,
    .SCAN_RESP_DATA_TAG_LEN                 = 10,	
    .DEVICE_NAME_TAG_LEN                    = 13,
