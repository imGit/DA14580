...
#define DGC_DEVICE_NAME "JPlus-x"	//define nanme 
...
/// Keyboard Test Application
///JPLUS Application
#if defined(CFG_APP_JPLUS)
#define BLE_APP_JPLUS   1
#else // defined(CFG_APP_JPLUS)
#define BLE_APP_JPLUS   0
#endif // defined(CFG_APP_JPLUS
