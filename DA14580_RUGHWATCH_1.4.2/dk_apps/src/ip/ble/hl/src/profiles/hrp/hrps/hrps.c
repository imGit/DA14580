...
const struct attm_desc hrps_att_db[HRS_IDX_NB] =
{
    ...
    [HRS_IDX_HR_MEAS_VAL]             =   {ATT_CHAR_HEART_RATE_MEAS, PERM(NTF, ENABLE)|PERM(RD, ENABLE), HRPS_HT_MEAS_MAX_LEN,	//PERM(NTF, ENABLE)   gsx
                                         0, NULL},
...
const struct att_char_desc hrps_hr_meas_char = ATT_CHAR(ATT_CHAR_PROP_NTF|ATT_CHAR_PROP_RD,	//ATT_CHAR_PROP_NTF   gsx
                                                          0,
